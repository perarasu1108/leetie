...
|------|---------|-----------|----------|--------------|---------------|
| all-possible-full-binary-trees | All Possible Full Binary Trees | Medium | java | [Problem](https://leetcode.com/problems/all-possible-full-binary-trees/) | [Solution](./solutions/Medium/0894-all-possible-full-binary-trees/solution.java) |
